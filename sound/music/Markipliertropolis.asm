Markiplier_Header:
	...
	smpsHeaderVoice     Markiplier_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $EA

	smpsHeaderDAC       Markiplier_DAC
	smpsHeaderFM        Markiplier_FM1,	$F4, $0E+$18
	smpsHeaderFM        Markiplier_FM2,	$18, $0A+$18
	smpsHeaderFM        Markiplier_FM3,	$0C, $14+$18
	smpsHeaderFM        Markiplier_FM4,	$0C, $16+$18
	smpsHeaderFM        Markiplier_FM5,	$0C, $16+$18
	smpsHeaderPSG       Markiplier_PSG1,	$E8, $06, $00, $00
	smpsHeaderPSG       Markiplier_PSG2,	$DC, $08, $00, $00
	smpsHeaderPSG       Markiplier_PSG3,	$00, $02, $00, fTone_03

; PSG1 Data
Markiplier_PSG1:
	smpsJump            Markiplier_Jump02
...
Markiplier_FM1:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $04, Markiplier_FM1

Markiplier_Loop09:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $04, Markiplier_Loop09
	smpsAlterPitch      $0C
	smpsSetvoice        $03
...
Markiplier_Loop0A:
	...
	smpsLoop            $00, $02, Markiplier_Loop0A
...
Markiplier_Loop0B:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $04, Markiplier_Loop0B

Markiplier_Loop0C:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $07, Markiplier_Loop0C
...
Markiplier_Loop0D:
	...
	smpsLoop            $00, $02, Markiplier_Loop0D

Markiplier_Loop0E:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $09, Markiplier_Loop0E
	smpsJump            Markiplier_Loop0C
...
Markiplier_Loop05:
	...
	smpsLoop            $00, $06, Markiplier_Loop05
	dc.b	nRst, $24
	smpsSetvoice        $00
	smpsAlterPitch      $0C
...
Markiplier_Loop03:
	...
	smpsLoop            $00, $06, Markiplier_Loop03
	dc.b	nRst, $24
	smpsAlterPitch      $0C
	smpsSetvoice        $00
...
Markiplier_Loop04:
	...
	smpsLoop            $00, $04, Markiplier_Loop04
	smpsPan             panLeft, $00
	smpsAlterPitch      $F4
	smpsSetvoice        $02
...
Markiplier_Loop01:
	dc.b	nRst, $60
	smpsLoop            $00, $04, Markiplier_Loop01
...
Markiplier_Loop02:
	...
	smpsLoop            $00, $04, Markiplier_Loop02
	smpsPan             panRight, $00
	smpsAlterPitch      $F4
	smpsSetvoice        $02
...
Markiplier_Jump00:
	...
	smpsJump            Markiplier_Jump00

Markiplier_Call00:
	dc.b	dKick, $0C, dLowTom, dSnare, dKick, dKick, dFloorTom, dSnare, dScratch, $04, $06, $02
	dc.b	dKick, $0C, dLowTom, dSnare, dKick, dKick, dFloorTom, dSnare, dMarkiplier2
	smpsReturn

; DAC Data
Markiplier_DAC:
	dc.b	dMarkiplier, $0C, dLowTom, dSnare, dKick, dKick, dFloorTom, dSnare, dScratch, $04, $06, $02
	dc.b	dKick, $0C, dLowTom, dSnare, dKick, dKick, dFloorTom, dSnare, dMarkiplier4
	smpsLoop            $00, $02, Markiplier_DAC

Markiplier_Loop00:
	smpsCall            Markiplier_Call00
	smpsLoop            $00, $0A, Markiplier_Loop00
	dc.b	dKick, $0C, dLowTom, dSnare, dKick, dKick, dFloorTom, dSnare, dScratch, $04, $06, $02
	dc.b	dKick, $0C, dLowTom, dSnare, dKick, dKick, dFloorTom, dSnare, dAMONGUS
	dc.b	dKick, $0C, dLowTom, dSnare, dKick, dKick, dFloorTom, dSnare, dScratch, $04, $06, $02
	dc.b	dKick, $0C, nRst, nRst, nRst, nRst, nRst, nRst, dMarkiplier3
	smpsJump            Markiplier_Loop00
