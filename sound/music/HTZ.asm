Snd_Twitter1_Header:
	...
	smpsHeaderVoice     Snd_Twitter1_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $44

	smpsHeaderDAC       Snd_Twitter1_DAC
	smpsHeaderFM        Snd_Twitter1_FM1,	$00, $0B
	smpsHeaderFM        Snd_Twitter1_FM2,	$00, $06
	smpsHeaderFM        Snd_Twitter1_FM3,	$00, $07
	smpsHeaderFM        Snd_Twitter1_FM4,	$00, $05
	smpsHeaderFM        Snd_Twitter1_FM5,	$0C, $13
	smpsHeaderPSG       Snd_Twitter1_PSG1,	$F4, $04, $00, $00
	smpsHeaderPSG       Snd_Twitter1_PSG2,	$F4, $04, $00, $00
	smpsHeaderPSG       Snd_Twitter1_PSG3,	$23, $02, $00, $00
...
Snd_Twitter1_Loop0D:
	...
	smpsLoop            $00, $02, Snd_Twitter1_Loop0D
	dc.b	nRst, $18
	smpsSetvoice        $04
	smpsModSet          $02, $01, $05, $04
	dc.b	nG5, $05, nRst, $07, nFs5, $05, nRst, $07, nF5, nFs5, $05
	smpsCall            Snd_Twitter1_Call07
...
Snd_Twitter1_Loop0E:
	...
	smpsCall            Snd_Twitter1_Call06
	dc.b	nRst, $0C, nEb4, $05, nRst, $1F, nC4, $05, nRst, $13
	smpsLoop            $00, $02, Snd_Twitter1_Loop0E
	dc.b	nRst, $18
	smpsSetvoice        $04
	smpsModSet          $02, $01, $05, $04
	...
	smpsAlterPitch      $F4
	smpsCall            Snd_Twitter1_Call02
	smpsAlterPitch      $0C
	smpsJump            Snd_Twitter1_FM1
...
Snd_Twitter1_Loop09:
	...
	smpsLoop            $00, $03, Snd_Twitter1_Loop09
	dc.b	nRst, $60

Snd_Twitter1_Loop0A:
	dc.b	nC2, $0C, nRst, $18, nC2, $0C, nRst, $30
	smpsLoop            $00, $08, Snd_Twitter1_Loop0A
	smpsCall            Snd_Twitter1_Call05
	dc.b	nG2, $06, nRst, nG2, nRst, $2A, nG2, $1E, nRst, $06, nRst, $60

Snd_Twitter1_Loop0B:
	dc.b	nC2, $0C, nRst, $18, nC2, $0C, nRst, $30
	smpsLoop            $00, $08, Snd_Twitter1_Loop0B

Snd_Twitter1_Loop0C:
	smpsCall            Snd_Twitter1_Call05
	smpsLoop            $00, $02, Snd_Twitter1_Loop0C
	dc.b	nG2, $06, nRst, nG2, nRst, $2A, nG2, $1E, nRst, $06
	smpsCall            Snd_Twitter1_Call02
	smpsJump            Snd_Twitter1_FM2
...
Snd_Twitter1_FM3:
	...
	smpsLoop            $00, $03, Snd_Twitter1_FM3
	dc.b	nRst, $60
...
Snd_Twitter1_Loop06:
	...
	smpsSetvoice        $02
	dc.b	nRst, $0C, nG4, $18, nG4, nG4, nG4, $0C
	smpsLoop            $00, $08, Snd_Twitter1_Loop06
	smpsNoteFill        $00
	smpsSetvoice        $03
	smpsCall            Snd_Twitter1_Call04
...
Snd_Twitter1_Loop07:
	...
	smpsSetvoice        $02
	dc.b	nRst, $0C, nG4, $18, nG4, nG4, nG4, $0C
	smpsLoop            $00, $08, Snd_Twitter1_Loop07

Snd_Twitter1_Loop08:
	smpsNoteFill        $00
	smpsSetvoice        $03
	smpsCall            Snd_Twitter1_Call04
	smpsLoop            $00, $02, Snd_Twitter1_Loop08
	dc.b	nRst, $0C, nD4, nRst, $07, nD4, $05, nRst, $0C, nD4, $05, nRst
	dc.b	$07, nRst, $24
	smpsCall            Snd_Twitter1_Call02
	smpsJump            Snd_Twitter1_FM3
...
Snd_Twitter1_FM4:
	...
	smpsLoop            $00, $03, Snd_Twitter1_FM4
	dc.b	nRst, $60
...
Snd_Twitter1_Loop03:
	...
	smpsSetvoice        $02
	dc.b	nC4, $0C, nE4, nG3, nE4, nC4, nE4, nG3, nE4
	smpsLoop            $00, $08, Snd_Twitter1_Loop03
	smpsNoteFill        $00
	smpsSetvoice        $03
	smpsCall            Snd_Twitter1_Call03
...
Snd_Twitter1_Loop04:
	...
	smpsSetvoice        $02
	dc.b	nC4, $0C, nE4, nG3, nE4, nC4, nE4, nG3, nE4
	smpsLoop            $00, $08, Snd_Twitter1_Loop04

Snd_Twitter1_Loop05:
	smpsNoteFill        $00
	smpsSetvoice        $03
	smpsCall            Snd_Twitter1_Call03
	smpsLoop            $00, $02, Snd_Twitter1_Loop05
	dc.b	nRst, $0C, nF3, nG2, $07, nF3, $05, nRst, $07, nG2, $05, nF3
	dc.b	nRst, $13, nF3, $07, nG3, $05, nF3, $07, nC3, $05
	smpsCall            Snd_Twitter1_Call02
	smpsJump            Snd_Twitter1_FM4
...
Snd_Twitter1_Loop02:
	smpsCall            Snd_Twitter1_Call01
	smpsLoop            $00, $02, Snd_Twitter1_Loop02
	dc.b	nRst, $0C, nA3, $0C, nRst, $07, nA3, $05, nRst, $0C, nA3, $05
	dc.b	nRst, $2B
	smpsCall            Snd_Twitter1_Call02
	smpsJump            Snd_Twitter1_FM5
...
Snd_Twitter1_PSG1:
	...
	;smpsModChange       $02
	dc.b	nRst, $0C, nG4, $18, nG4, nG4, nG4, $0C
	smpsLoop            $00, $03, Snd_Twitter1_PSG1
	dc.b	nRst, $60
...
Snd_Twitter1_Loop15:
	...
	smpsPSGvoice        sTone_05
	dc.b	nRst, $0C, nG4, $18, nG4, nG4, nG4, $0C
	smpsLoop            $00, $08, Snd_Twitter1_Loop15
	smpsNoteFill        $00
...
Snd_Twitter1_Loop16:
	...
	smpsPSGvoice        sTone_05
	dc.b	nRst, $0C, nG4, $18, nG4, nG4, nG4, $0C
	smpsLoop            $00, $08, Snd_Twitter1_Loop16

Snd_Twitter1_Loop17:
	smpsNoteFill        $00
	smpsPSGvoice        sTone_04
	smpsCall            Snd_Twitter1_Call04
	smpsLoop            $00, $02, Snd_Twitter1_Loop17
	dc.b	nRst, $0C, nD4, nRst, $07, nD4, $05, nRst, $0C, nD4, $05, nRst
	dc.b	$07, nRst, $24, nRst, $60, nRst
	smpsJump            Snd_Twitter1_PSG1
...
Snd_Twitter1_PSG2:
	...
	smpsNoteFill        $06
	dc.b	nC4, $0C, nE4, nG3, nE4, nC4, nE4, nG3, nE4
	smpsLoop            $00, $03, Snd_Twitter1_PSG2
	dc.b	nRst, $60
	smpsPSGvoice        sTone_12
...
Snd_Twitter1_Loop12:
	smpsNoteFill        $06
	dc.b	nC4, $0C, nE4, nG3, nE4, nC4, nE4, nG3, nE4
	smpsLoop            $00, $08, Snd_Twitter1_Loop12
	smpsNoteFill        $00
...
Snd_Twitter1_Loop13:
	...
	smpsPSGvoice        sTone_12
	dc.b	nC4, $0C, nE4, nG3, nE4, nC4, nE4, nG3, nE4
	smpsLoop            $00, $08, Snd_Twitter1_Loop13

Snd_Twitter1_Loop14:
	smpsNoteFill        $00
	smpsPSGvoice        sTone_11
	smpsCall            Snd_Twitter1_Call03
	smpsLoop            $00, $02, Snd_Twitter1_Loop14
	dc.b	nRst, $0C, nF3, nG2, $07, nF3, $05, nRst, $07, nG2, $05, nF3
	dc.b	nRst, $13, nF3, $07, nG3, $05, nF3, $07, nC3, $05, nRst, $60
	dc.b	nRst
	smpsJump            Snd_Twitter1_PSG2
...
Snd_Twitter1_Loop0F:
	smpsCall            Snd_Twitter1_Call08
	smpsLoop            $00, $03, Snd_Twitter1_Loop0F
	dc.b	(nMaxPSG2-$23)&$FF, $0C, nRst, $54

Snd_Twitter1_Loop10:
	smpsCall            Snd_Twitter1_Call08
	smpsLoop            $00, $0B, Snd_Twitter1_Loop10
	dc.b	(nMaxPSG2-$23)&$FF, $0C, nRst, $54

Snd_Twitter1_Loop11:
	smpsCall            Snd_Twitter1_Call08
	smpsLoop            $00, $0D, Snd_Twitter1_Loop11
	dc.b	(nMaxPSG2-$23)&$FF, $0C, nRst, $54, nRst, $60
	smpsJump            Snd_Twitter1_Loop0F
...
; DAC Data
Snd_Twitter1_DAC:
	dc.b	dKickHey, $0C, dAMONGUS, dFREDDYFAXBEAR, $24, dKickHey, $0C, dGOSnare, dGOSnare
	smpsLoop            $00, $03, Snd_Twitter1_DAC
	dc.b	dKickHey, $48, dAMONGUS, $18

Snd_Twitter1_Loop00:
	dc.b	dKickHey, $0C, dAMONGUS, dFREDDYFAXBEAR, $24, dKickHey, $0C, dGOSnare, dGOSnare
	smpsLoop            $00, $0B, Snd_Twitter1_Loop00
	dc.b	dKickHey, $48, dAMONGUS, $18

Snd_Twitter1_Loop01:
	dc.b	dKickHey, $0C, dAMONGUS, dFREDDYFAXBEAR, $24, dKickHey, $0C, dGOSnare, dGOSnare
	smpsLoop            $00, $0D, Snd_Twitter1_Loop01
	dc.b	dSnareS3, $60, dWerehog
	smpsJump            Snd_Twitter1_DAC
